...
function myFunctionTest(expected, found) {
  ...
  console.log("Expected output of findLongestWord(['a', 'bc', 'def']) is 3  " + myFunctionTest(3, findLongestWord(['a', 'bc', 'def'])));
  ...
  console.log("Expected output of filterLongWords(['a', 'bc', 'def'], 2) is ['def']  " + myFunctionTest(['def'], filterLongWords(['a', 'bc', 'def'], 2)));
  ...
  function filterElem(a, num){
      return a.filter(function(elem, i, array){
          return elem === num;
      });
  }
  console.log("Expected output of filterElem([1,3,5,3,3], 3) is [3,3,3]  " + myFunctionTest([3,3,3], filterElem([1,3,5,3,3], 3)));
